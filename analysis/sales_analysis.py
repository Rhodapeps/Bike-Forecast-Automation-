...
mkdir("data/data_wrangled")

bike_orderlines_wrangled_df.to_pickle("data/data_wrangled/bike_orderlines_wrangled_df.pkl")

df = pd.read_pickle("data/data_wrangled/bike_orderlines_wrangled_df.pkl")
...
df.to_pickle("data/data_wrangled/bike_orderlines_wrangled_df.pkl")

# CSV ----

df.to_csv("data/data_wrangled/bike_orderlines_wrangled_df.csv")

# Excel ----

df.to_excel("data/data_wrangled/bike_orderlines_wrangled_df.xlsx")
